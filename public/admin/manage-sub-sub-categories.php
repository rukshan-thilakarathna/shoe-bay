...
$catname1 = $db->prepare("SELECT `cn` ,`scid` FROM `categories` WHERE `cid`=?");
$catname1->execute([$_GET['sub_cat_id']]);
$catname = $catname1->fetch();

$catname2 = $db->prepare("SELECT `cn`  FROM `categories` WHERE `cid`=?");
$catname2->execute([$catname['scid']]);
$mcatname = $catname2->fetch();
...
$q="SELECT * FROM `categories` WHERE `ssid`=? ";
$a = array($_GET['sub_cat_id']);
/// search start
$zysna = "";
$zysid = "";
$zysst = 0;
...
?>
<title>Manage <?php echo $catname['cn']; ?> Categories</title>
...
<div class="w" id="zy1">
	<h1>Manage <?php echo $catname['cn']; ?> Category</h1>
	<p class="zp">Manage <?php echo $catname['cn']; ?> Category - Add, Edit & Delete Categories</p>
    <p> <a style="text-decoration: none;color: #ccc;" href="admin/dashboard.php">Dashboard</a> > <a style="text-decoration: none;color: #ccc;" href="admin/manage-categories.php">Main Categorys</a> > <a style="text-decoration: none;color: #ccc;" href="admin/manage-sub-categories.php?sub_cat_id=<?php echo $catname['scid']; ?>""><?php   echo $mcatname['cn']; ?></a> > <?php echo $catname[0]; ?></p>
	<button data-main-id="<?php echo $_GET['sub_cat_id']; ?>" id="x5bt" ><span data-main-id="<?php echo $_GET['sub_cat_id']; ?>" id="x5s">Add New</span> <img data-main-id="<?php echo $_GET['sub_cat_id']; ?>" src="admin/img/add.svg" alt="Add New" id="x5i"></button>
	<div id="x1d">
		<div id="x1d1">
...
?>		
	<div class="x5t">
		<div class="x5r">
            ...
            <div class="x5c x5e">Main Category</div>
        ...
        foreach($row as $r){
            ...
            echo '<div class="x5c">',$catname['cn'],'</div>';
