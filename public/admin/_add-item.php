...
function imgUp($imgArr,&$e1,&$e2,&$e3,&$e4,&$e5,$fileName="") {
	...
	*/		
			...
			if(!in_array(TRUE, $err)){
				...
				$OK = $db->prepare("INSERT INTO `items` (`na`, `cd`, `ca`, `pr`, `vo`, `pe`, `co`, `br`, `mt`, `md`, `az`,`dt`,`uz`,`iz`) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)")->execute([$zyna, $zycd, $zyca, $zypr, $zyvo, $zype, $zyco, $zybr, $zymt, $zymd, $zyaz, date('Y-m-d'), $zyuz, $iz]);
			}
		}else{
			$zyna = "";
			$zycd = "";
