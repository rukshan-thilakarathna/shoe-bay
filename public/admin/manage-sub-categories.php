...
$catname1 = $db->prepare("SELECT `cn` FROM `categories` WHERE `cid`=?");
...
?>
<title>Manage <?php echo $catname[0]; ?> Categories</title>
...
<div class="w" id="zy1">
	<h1>Manage <?php echo $catname[0]; ?> Category</h1>
	<p class="zp">Manage <?php echo $catname[0]; ?> Category - Add, Edit & Delete Categories</p>
    <p> <a style="text-decoration: none;color: #ccc;" href="admin/dashboard.php">Dashboard</a> > <a style="text-decoration: none;color: #ccc;" href="admin/manage-categories.php">Main Categorys</a> > <?php echo $catname[0]; ?></p>
...
?>		
	<div class="x5t">
        ...
        foreach($row as $r){
            ...
            echo '<div class="x5c">',$catname[0],'</div>';
...
" class="x5c"><a style="
    ...
    padding: 7px;
    margin: 0 0 0 12px;
    border-radius: 5px;" href="http://localhost/shoe-bay/public/admin/manage-sub-sub-categories.php?sub_cat_id=',$r['cid'],'">Manage '.$r['cn'].'</a></div>';
            echo '</div>';
        }
        ?>
		</div>
